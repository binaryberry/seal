...
TEAM_REPOS = %w(calendars contacts-admin contacts-frontend content-register content-store courts-api courts-frontend hmrc-manuals-api imminence licence-finder manuals-frontend optic14n pre-transition-stats publishing-api side-by-side-browser smart-answers specialist-publisher static trade-tariff-admin trade-tariff-backend trade-tariff-frontend transition transition-stats url-arbiter whitehall).sort!
TEAM_CHANNEL = "#custom"
